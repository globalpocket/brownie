...
mod tests {
    ...
    fn prompt_builder_moves_to_implement_patch_after_completed_read() {
        ...
        assert!(prompt.messages[0]
            .content
            .contains("Never infer or invent patch_file old_text"));
    }
