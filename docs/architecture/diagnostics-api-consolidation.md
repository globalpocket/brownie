...
## Exact Current Method And Type Inventory

This inventory was taken from the Rust runtime and VSIX client surfaces during R1 review. Each row names the JSON-RPC method and its protocol type pair. The long-chain rows are compatibility surfaces only; they should not be extended.

| Existing JSON-RPC method | Protocol type pair | R1 classification |
| --- | --- | --- |
| `proposal.reviewQueue` | `ProposalReviewQueueParams` / `ProposalReviewQueueResult` | Keep |
| `proposal.reviewQueueDiagnostics` | `ProposalReviewQueueDiagnosticsParams` / `ProposalReviewQueueDiagnosticsResult` | Keep |
| `proposal.reviewQueueDiagnosticsHistory` | `ProposalReviewQueueDiagnosticsHistoryParams` / `ProposalReviewQueueDiagnosticsHistoryResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsReport` | `ProposalReviewQueueDiagnosticsReportParams` / `ProposalReviewQueueDiagnosticsReportResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigest` | `ProposalReviewQueueDiagnosticsDigestParams` / `ProposalReviewQueueDiagnosticsDigestResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestHistory` | `ProposalReviewQueueDiagnosticsDigestHistoryParams` / `ProposalReviewQueueDiagnosticsDigestHistoryResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReport` | `ProposalReviewQueueDiagnosticsDigestReportParams` / `ProposalReviewQueueDiagnosticsDigestReportResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportHistory` | `ProposalReviewQueueDiagnosticsDigestReportHistoryParams` / `ProposalReviewQueueDiagnosticsDigestReportHistoryResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportVerdict` | `ProposalReviewQueueDiagnosticsDigestReportVerdictParams` / `ProposalReviewQueueDiagnosticsDigestReportVerdictResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportVerdictHistory` | `ProposalReviewQueueDiagnosticsDigestReportVerdictHistoryParams` / `ProposalReviewQueueDiagnosticsDigestReportVerdictHistoryResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportVerdictReport` | `ProposalReviewQueueDiagnosticsDigestReportVerdictReportParams` / `ProposalReviewQueueDiagnosticsDigestReportVerdictReportResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportVerdictReportHistory` | `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryParams` / `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportVerdictReportHistoryDigest` | `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestParams` / `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistory` | `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistoryParams` / `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistoryResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistoryReport` | `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistoryReportParams` / `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistoryReportResult` | Deprecate candidate |
| `proposal.reviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistoryReportHistory` | `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistoryReportHistoryParams` / `ProposalReviewQueueDiagnosticsDigestReportVerdictReportHistoryDigestHistoryReportHistoryResult` | Deprecate candidate |
