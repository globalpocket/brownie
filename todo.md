...
- [ ] E-03a-next-next-next-next: Resolve release evidence collection blocker before E-03a-next-next-next can close:
  Brownie confirmed the implementation/tested commit from `git.status` (`0e59550c187abeec0c087c476934d252a5d81e3f`), but
