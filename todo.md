...
- [ ] E-03a-next-next-next: Resolve release evidence collection blocker before E-03a-next-next can close:
  Brownie confirmed the implementation/tested commit from `git.status` (`5027e51f1072d1ff0e3f403a683cb5e4c11aa6ab`), but
