...
export interface ObjectiveProposalAuthorizationPreflightTarget {
...
export interface HeadlessContinueOnceParams {
  ...
  continuation_scope?: HeadlessContinueScope | null;
...
export interface HeadlessContinueScope {
  session_id?: string | null;
  session_id_prefix?: string | null;
  journey_id?: string | null;
  task_id?: string | null;
  run_id?: string | null;
  latest_matching_session?: boolean;
}
...
export interface HeadlessRunDriveParams {
  ...
  selected_product_gap_closure?: HeadlessRunSelectedProductGapClosureRequest | null;
...
export interface HeadlessRunSelectedProductGapClosureRequest {
  authorize_selected_product_gap_closure: true;
  closure_id: string;
  source_decision_id: string;
  expected_source_decision_fingerprint: string;
  expected_product_evidence_fingerprint: string;
  expected_selected_remaining_gap_fingerprint: string;
  expected_product_objective_fingerprint: string;
  expected_accepted_completion_fingerprint: string;
  expected_terminal_completion_fingerprint: string;
  expected_completion_closure_fingerprint: string;
}
...
export type HeadlessContinueRouteKind =
  ...
  | 'admit_product_continuation_task_explicitly'
...
export interface HeadlessContinueOnceResult {
  ...
  objective_proposal_authorization_preflight_result?: HeadlessRunObjectiveProposalAuthorizationPreflight | null;
...
export interface HeadlessRunDriveResult {
  ...
  selected_product_gap_closure?: HeadlessRunSelectedProductGapClosureEvidence | null;
...
export interface HeadlessRunSelectedProductGapClosureEvidence {
  closure_id: string;
  task_id: string;
  run_id: string;
  acceptance_id: string;
  ...
  product_evidence_fingerprint: string;
  product_objective_fingerprint: string;
  selected_remaining_gap: HeadlessRunProductRemainingGapSelection;
  accepted_completion_fingerprint: string;
  terminal_completion_fingerprint: string;
  completion_closure_fingerprint: string;
  closure_evidence_fingerprint: string;
  status: string;
  next_action: string;
  replayed: boolean;
}
...
export interface HeadlessRunObjectiveProposalAuthorizationPreflight {
  ...
  preflight_snapshot: WorkspacePatchPreflightSnapshotSummary;
  apply_plan: WorkspacePatchApplyPlanSummary;
  authorization_preflight_fingerprint: string;
  replayed: boolean;
...
export interface TaskListHeadlessRouteCandidate {
  ...
  journey_id?: string | null;
  session_id?: string | null;
  journey_fingerprint?: string | null;
  next_session_sequence?: number | null;
  progress_fingerprint: string;
  aggregate_sequence: number;
...
export function isHeadlessContinueOnceParams(value: unknown): value is HeadlessContinueOnceParams {
  return (
    ...
    (value.continuation_scope === undefined || value.continuation_scope === null || isHeadlessContinueScope(value.continuation_scope)) &&
...
function isHeadlessContinueScope(value: unknown): value is HeadlessContinueScope {
  const selectorCount = isRecord(value)
    ? [value.session_id, value.session_id_prefix, value.journey_id, value.task_id, value.run_id].filter((selector) => selector !== undefined && selector !== null).length
    : 0;
  return (
    isRecord(value) &&
    hasOnlyFields(value, ['session_id', 'session_id_prefix', 'journey_id', 'task_id', 'run_id', 'latest_matching_session']) &&
    selectorCount >= 1 &&
    (value.session_id === undefined || value.session_id === null || isHeadlessContinuationId(value.session_id)) &&
    (value.session_id_prefix === undefined || value.session_id_prefix === null || isHeadlessContinuationId(value.session_id_prefix)) &&
    (value.journey_id === undefined || value.journey_id === null || isHeadlessContinuationId(value.journey_id)) &&
    (value.task_id === undefined || value.task_id === null || isHeadlessContinuationId(value.task_id)) &&
    (value.run_id === undefined || value.run_id === null || isHeadlessContinuationId(value.run_id)) &&
    (value.latest_matching_session === undefined || typeof value.latest_matching_session === 'boolean')
  );
}

function isObjectiveProposalAuthorizationPreflightTarget(value: unknown): value is ObjectiveProposalAuthorizationPreflightTarget {
  return (
    isRecord(value) &&
    hasOnlyFields(value, [
      'authorize_objective_proposal_preflight',
      'journey_id',
      'session_id',
      'source_drive_id',
    ...
    hasNoForbiddenRawFields(value) &&
    value.authorize_objective_proposal_preflight === true &&
...
export function isHeadlessRunAdvanceParams(value: unknown): value is HeadlessRunAdvanceParams {
  return (
    isRecord(value) &&
    hasOnlyFields(value, ['authorize', 'session_id', 'advance_id', 'expected_session_sequence', 'continuation_scope', 'max_steps', 'context_budget', 'selected_index_context', 'product_continuation_admission_target', 'product_continuation_run_target', 'product_continuation_derived_target', 'expected_progress_fingerprint', 'expected_aggregate_sequence', 'modepack_registry_update_selection_target', 'modepack_selected_candidate_fetch_target', 'modepack_selected_candidate_provenance_verification_target', 'modepack_selected_candidate_approval_target', 'modepack_selected_approved_candidate_replacement_target']) &&
    value.authorize === true &&
    isHeadlessRunId(value.session_id) &&
...
export function isHeadlessRunDriveParams(value: unknown): value is HeadlessRunDriveParams {
  ...
  return (
    isRecord(value) &&
    hasOnlyFields(value, ['authorize', 'session_id', 'drive_id', 'expected_start_session_sequence', 'max_advances', 'max_steps_per_advance', 'context_budget', 'product_continuation_admission_target', 'product_continuation_run_target', 'product_continuation_derived_target', 'authorize_completion_finalization', 'expected_completion_closure_fingerprint', 'product_evidence_derivation', 'selected_product_gap_closure', 'product_completion_decision', 'modepack_registry_update_selection_target', 'modepack_selected_candidate_fetch_target', 'modepack_selected_candidate_provenance_verification_target', 'modepack_selected_candidate_approval_target', 'modepack_selected_approved_candidate_replacement_target', 'journey_admission', 'journey_route_resume', 'journey_closure', 'journey_execution']) &&
    value.authorize === true &&
    isHeadlessRunId(value.session_id) &&
    ...
    (value.selected_product_gap_closure === undefined || value.selected_product_gap_closure === null || isHeadlessRunSelectedProductGapClosureRequest(value.selected_product_gap_closure)) &&
...
function isProductContinuationAdmissionTarget(value: unknown): value is ProductContinuationAdmissionTarget {
  return (
    isRecord(value) &&
    hasOnlyFields(value, [
      'authorize_product_continuation_admission',
      'product_continuation_source',
      'continuation_goal',
      'continuation_mode_id',
    ]) &&
    value.authorize_product_continuation_admission === true &&
    isProductContinuationSource(value.product_continuation_source) &&
    typeof value.continuation_goal === 'string' &&
...
export function isHeadlessContinueOnceResult(value: unknown): value is HeadlessContinueOnceResult {
  if (
    ...
    (value.objective_proposal_authorization_preflight_result !== undefined && value.objective_proposal_authorization_preflight_result !== null && !isHeadlessRunObjectiveProposalAuthorizationPreflight(value.objective_proposal_authorization_preflight_result)) ||
  ...
  if (
    ...
    value.objective_proposal_authorization_preflight_result !== undefined &&
  ...
  if (
    ...
    return value.selected_task_id == null && value.selected_run_id == null && value.task_run_result == null && value.objective_proposal_authorization_preflight_result == null && value.modepack_select_registry_update_result == null && value.modepack_replace_active_result == null && value.modepack_rollback_active_result == null && value.next_route !== undefined && value.next_route !== null && isModePackRouteKind(value.next_route.kind, 'verify_selected_mode_pack_candidate_provenance_explicitly', 'verify_selected_modepack_candidate_provenance_explicitly');
  }
  if (
    value.status === 'task_executed' &&
    value.stale === false &&
...
export function isHeadlessRunDriveResult(value: unknown): value is HeadlessRunDriveResult {
  return (
    ...
    (value.selected_product_gap_closure === undefined || value.selected_product_gap_closure === null || isHeadlessRunSelectedProductGapClosureEvidence(value.selected_product_gap_closure)) &&
...
export function isHeadlessRunObjectiveProposalAuthorizationPreflight(value: unknown): value is HeadlessRunObjectiveProposalAuthorizationPreflight {
  return (
    isRecord(value) &&
    hasOnlyFields(value, ['status', 'journey_id', 'task_id', 'run_id', 'session_id', 'source_drive_id', 'proposal_id', 'source_event_id', 'source_event_kind', 'operation', 'path_fingerprint', 'objective_context_fingerprint', 'selected_context_fingerprint', 'candidate_fingerprint', 'authorization_token_fingerprint', 'validation_status', 'approval_status', 'approved_at', 'preflight_snapshot', 'apply_plan', 'authorization_preflight_fingerprint', 'replayed', 'next_action']) &&
    hasNoForbiddenRawFields(value) &&
    value.status === 'authorized_preflight_ready' &&
    isHeadlessRunId(value.journey_id) &&
    isBoundedHandle(value.task_id) &&
    isBoundedHandle(value.run_id) &&
    isHeadlessRunId(value.session_id) &&
    isHeadlessRunId(value.source_drive_id) &&
    isBoundedHandle(value.proposal_id) &&
    isBoundedHandle(value.source_event_id) &&
    value.source_event_kind === 'WorkspacePatchProposed' &&
    value.operation === 'replace_file' &&
    typeof value.path_fingerprint === 'string' &&
    isSha256Fingerprint(value.path_fingerprint) &&
    typeof value.objective_context_fingerprint === 'string' &&
    isSha256Fingerprint(value.objective_context_fingerprint) &&
    typeof value.selected_context_fingerprint === 'string' &&
    isSha256Fingerprint(value.selected_context_fingerprint) &&
    ...
    (value.approved_at === undefined || value.approved_at === null || (typeof value.approved_at === 'string' && value.approved_at.length > 0 && value.approved_at.length <= 64)) &&
    isWorkspacePatchPreflightSnapshotSummary(value.preflight_snapshot) &&
    isWorkspacePatchApplyPlanSummary(value.apply_plan) &&
    value.preflight_snapshot.proposal_id === value.proposal_id &&
    value.apply_plan.proposal_id === value.proposal_id &&
    value.apply_plan.status === 'Ready' &&
    typeof value.authorization_preflight_fingerprint === 'string' &&
    isSha256Fingerprint(value.authorization_preflight_fingerprint) &&
    typeof value.replayed === 'boolean' &&
    value.next_action === 'apply_authorized_objective_proposal' &&
...
export function isHeadlessRunSelectedProductGapClosureRequest(value: unknown): value is HeadlessRunSelectedProductGapClosureRequest {
  return (
    isRecord(value) &&
    hasOnlyFields(value, [
      'authorize_selected_product_gap_closure',
      'closure_id',
      'source_decision_id',
    ...
    hasNoForbiddenRawFields(value) &&
    value.authorize_selected_product_gap_closure === true &&
    isHeadlessRunId(value.closure_id) &&
    isHeadlessRunId(value.source_decision_id) &&
    typeof value.expected_source_decision_fingerprint === 'string' &&
    isSha256Fingerprint(value.expected_source_decision_fingerprint) &&
    typeof value.expected_product_evidence_fingerprint === 'string' &&
    isSha256Fingerprint(value.expected_product_evidence_fingerprint) &&
    typeof value.expected_selected_remaining_gap_fingerprint === 'string' &&
    isSha256Fingerprint(value.expected_selected_remaining_gap_fingerprint) &&
    typeof value.expected_product_objective_fingerprint === 'string' &&
    isSha256Fingerprint(value.expected_product_objective_fingerprint) &&
    typeof value.expected_accepted_completion_fingerprint === 'string' &&
    isSha256Fingerprint(value.expected_accepted_completion_fingerprint) &&
    typeof value.expected_terminal_completion_fingerprint === 'string' &&
    isSha256Fingerprint(value.expected_terminal_completion_fingerprint) &&
...
export function isHeadlessRunSelectedProductGapClosureEvidence(value: unknown): value is HeadlessRunSelectedProductGapClosureEvidence {
  return (
    isRecord(value) &&
    hasOnlyFields(value, [
      'closure_id',
    ...
    isBoundedHandle(value.run_id) &&
    isHeadlessRunId(value.acceptance_id) &&
    typeof value.source_decision_fingerprint === 'string' &&
    isSha256Fingerprint(value.source_decision_fingerprint) &&
    typeof value.product_evidence_fingerprint === 'string' &&
    isSha256Fingerprint(value.product_evidence_fingerprint) &&
    typeof value.product_objective_fingerprint === 'string' &&
    isSha256Fingerprint(value.product_objective_fingerprint) &&
    isHeadlessRunProductRemainingGapSelection(value.selected_remaining_gap) &&
    typeof value.accepted_completion_fingerprint === 'string' &&
    isSha256Fingerprint(value.accepted_completion_fingerprint) &&
    typeof value.terminal_completion_fingerprint === 'string' &&
    ...
    typeof value.completion_closure_fingerprint === 'string' &&
    isSha256Fingerprint(value.completion_closure_fingerprint) &&
    typeof value.closure_evidence_fingerprint === 'string' &&
    isSha256Fingerprint(value.closure_evidence_fingerprint) &&
    value.status === 'closed' &&
    value.next_action === 'derive_product_evidence_matrix_with_closed_gap' &&
    typeof value.replayed === 'boolean'
  );
}
...
function isTaskListHeadlessRouteCandidate(value: unknown): value is TaskListHeadlessRouteCandidate {
  return (
    isRecord(value) &&
    hasOnlyFields(value, ['kind', 'reason', 'task_id', 'run_id', 'proposal_id', 'apply_id', 'failure_fingerprint', 'apply_fingerprint', 'journey_id', 'session_id', 'journey_fingerprint', 'next_session_sequence', 'progress_fingerprint', 'aggregate_sequence', 'route_fingerprint', 'priority', 'next_action']) &&
    hasNoForbiddenTaskListProgressFields(value) &&
    isHeadlessContinueRouteKind(value.kind) &&
    typeof value.reason === 'string' &&
    value.reason.length > 0 &&
    ...
    (value.failure_fingerprint === undefined || value.failure_fingerprint === null || (typeof value.failure_fingerprint === 'string' && isSha256Fingerprint(value.failure_fingerprint))) &&
    (value.apply_fingerprint === undefined || value.apply_fingerprint === null || (typeof value.apply_fingerprint === 'string' && isSha256Fingerprint(value.apply_fingerprint))) &&
    (value.journey_id === undefined || value.journey_id === null || isHeadlessRunId(value.journey_id)) &&
    (value.session_id === undefined || value.session_id === null || isHeadlessRunId(value.session_id)) &&
    (value.journey_fingerprint === undefined || value.journey_fingerprint === null || (typeof value.journey_fingerprint === 'string' && isSha256Fingerprint(value.journey_fingerprint))) &&
    (value.next_session_sequence === undefined || value.next_session_sequence === null || (isNonNegativeInteger(value.next_session_sequence) && value.next_session_sequence >= 1)) &&
    typeof value.progress_fingerprint === 'string' &&
    isSha256Fingerprint(value.progress_fingerprint) &&
    isNonNegativeInteger(value.aggregate_sequence) &&
