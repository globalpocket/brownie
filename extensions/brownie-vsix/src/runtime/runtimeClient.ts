...
export class RuntimeClient {
  ...
  async selectModePackRegistryUpdate(
    authorizeRegistrySelection: boolean,
    registryUrl: string,
    ...
    if (!isModePackSelectRegistryUpdateResult(result)) {
      throw new RuntimeProtocolError('modepack.selectRegistryUpdate returned an invalid result');
    }
