...
import type { ModePackActivateResult, ModePackApproveCandidateResult, ModePackFetchCandidateResult, ModePackReplaceActiveResult, ModePackRollbackActiveResult, ModePackTrustSignerResult, ModePackVerifyCandidateProvenanceResult } from './protocol';
...
import { isModePackActivateResult, isModePackApproveCandidateResult, isModePackFetchCandidateResult, isModePackReplaceActiveResult, isModePackRollbackActiveResult, isModePackTrustSignerResult, isModePackVerifyCandidateProvenanceResult } from './protocol';
